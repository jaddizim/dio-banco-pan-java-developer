...
-- RECUPERAÇÃO DOS GERENTES E SEUS DEPARTAMENTOS
SELECT 
    Ssn, Fname, Dname
FROM
    employee e,
...
-- RECUPERAÇÃO DOS DEPENDENTES E RELAÇÃO DE PARENTESCO
SELECT 
...
-- RECUPERAÇÃO DE ANIVERSÁRIO E ENDEREÇO DO EMPREGADO
SELECT 
    Bdate, Adress
FROM
    employee
...
-- RECUPERAÇÃO DE DEPARTAMENTO ESPECÍFICO
SELECT 
    *
FROM
    department
...
-- RECUPERAÇÃO DE NOME E ENDEREÇO DE EMPREGADO
SELECT 
    Fname, Lname, Adress
FROM
    employee e,
...
-- RECUPERAÇÃO DE DADOS DE PROJETO E EMPREGADO
SELECT 
    Pname, Essn, Fname, Hours
FROM
    project,
    works_on,
    employee
